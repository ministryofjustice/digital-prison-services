...
context('A user can view non associations', () => {
  ...
  it('Shows the correct data for non-associations', () => {
    ...
    nonAssociationsPage.message().contains('You must also check any local processes for non-association details.')
    nonAssociationsPage.backLink().contains('Return to select an available cell')
