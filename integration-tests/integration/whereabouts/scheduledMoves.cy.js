...
const holdAgainstTransferAlertDetailsResponse = [
  {
    ...
    alertCode: { code: 'TAH', description: 'Allocation Hold', alertTypeCode: 'T', alertTypeDescription: 'Hold Against Transfer' },
    description: 'Comment text here',
    createdAt: '2009-11-24',
    expired: false,
    isActive: true,
    createdByDisplayName: 'Odrahoon Marshald',
    activeToLastSetByDisplayName: 'ADMIN&ONB CNOMIS',
  },
  {
    alertId: 1,
    bookingId: 42739,
    offenderNo: 'G5966UI',
    alertCode: { code:'TSE', description: 'Security Hold', alertTypeCode: 'T', alertTypeDescription: 'Hold Against Transfer' },
