    ...
    attendanceStatsSuspendedPage.offenderList().then(($table) => {
      cy.get($table)
        ...
        .then(($tableRows) => {
          ...
          expect(suspensions[2].name).to.contain('Three, Offender')
          expect(suspensions[2].offenderNo).to.eq('G8976UK')
          expect(suspensions[2].location).to.eq('WWI-3')
          expect(suspensions[2].activity).to.contain('Cleaner')
          expect(suspensions[2].attended).to.contain('Yes')
          expect(suspensions[3].name).to.contain('Two, Offender')
          expect(suspensions[3].offenderNo).to.eq('G8975UK')
          expect(suspensions[3].location).to.eq('WWI-2')
          expect(suspensions[3].activity).to.contain('Cleaner')
          expect(suspensions[3].attended).to.contain('No - refused')
