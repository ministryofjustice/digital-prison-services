...
describe('PaymentReasonModal', () => {
  ...
  it('should call onConfirm with the selected reason and comment, and onClose', () => {
    ...
    expect(props.onConfirm.mock.calls[0][0].reasons).toEqual([
      { value: 'Refused', commentRequired: true },
      { value: 'Left in Cell', commentRequired: true },
    ])
