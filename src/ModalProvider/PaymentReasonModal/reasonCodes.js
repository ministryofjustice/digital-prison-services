...
export const getHouseBlockReasons = () => [
  ...
  { value: 'F35 Certificate (Medical)', mapping: { eventOutcome: 'ACCAB', performance: 'STANDARD' }, commentRequired: true },
  ...
  { value: 'Unacceptable Performance', mapping: { eventOutcome: 'ATT', performance: 'UNACCEPT' }, commentRequired: true }
];
