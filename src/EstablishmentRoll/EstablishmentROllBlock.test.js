...
describe('<EstablishmentRollBlock />', () => {
  ...
  describe('when highlight prop is true', () => {
    ...
    it('should apply the highlight class', () => {
      expect(
        wrapper.find('.establishment-roll-block').hasClass('establishment-roll-block--highlight'),
      ).toBe(true);
    });
  });
  ...
  describe('when isLastBlock prop is true', () => {
    ...
    it('should apply the last class', () => {
      expect(
        wrapper.find('.establishment-roll-block').hasClass('establishment-roll-block--last'),
      ).toBe(true);
    });
  });
});
