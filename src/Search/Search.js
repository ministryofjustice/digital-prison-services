    ...
    const periodSelect = (
      <div className="pure-u-md-3-12">
        ...
        <select id="period-select" name="period-select" className="form-control"
          ...
          <option key="MORNING" value="MORNING">Morning (AM)</option>
          <option key="AFTERNOON" value="AFTERNOON">Afternoon (PM)</option>
          <option key="EVENING" value="EVENING">Evening (ED)</option>
        </select></div>);
