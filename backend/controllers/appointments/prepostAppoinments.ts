...
const prepostAppointmentsFactory = ({
  ...
  const handleLocationEventsIfRequired = async (
    ...
    if (preAppointmentLocation) {
      ...
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'preAppointment' does not exist on type '... Remove this comment to see the full error message
    ...
    if (postAppointmentLocation) {
      ...
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'postAppointment' does not exist on type ... Remove this comment to see the full error message
