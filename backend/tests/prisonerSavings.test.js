...
describe('Prisoner savings', () => {
  ...
  beforeEach(() => {
    ...
    controller = prisonerSavings({ prisonApi, prisonerFinanceService })
  })

  it('should make the expected calls', async () => {
    const params = [res.locals, offenderNo, 'savings', undefined, undefined]
  ...
  describe('with transaction data', () => {
    ...
    it('should render the correct template with the correct information', async () => {
      ...
      expect(res.render).toHaveBeenCalledWith('prisonerProfile/prisonerFinance/savings.njk', {
  ...
  describe('when selecting a month and year', () => {
    ...
    it('should pass make the correct calls to prisonerFinanceService', async () => {
      const params = [res.locals, offenderNo, 'savings', '6', '2020']
      await controller(req, res)
