...
describe('prisoner sentence and release', () => {
  ...
  it('should only return sentence, offences and court cases where they result in imprisonment', async () => {
    ...
    prisonApi.getOffenceHistory.mockResolvedValue([
      ...
      {
        offenceDescription: 'Offence 6',
        primaryResultCode: '3045',
        caseId: 6,
      },
      {
        offenceDescription: 'Offence 7',
        primaryResultCode: '1046',
        caseId: 7,
      },
      {
        offenceDescription: 'Offence 8',
        primaryResultCode: '1081',
        caseId: 8,
      },
      {
        offenceDescription: 'Offence 9',
        primaryResultCode: '1003',
        caseId: 9,
      },
      {
        offenceDescription: 'Offence 10',
        primaryResultCode: '2003',
        caseId: 10,
      },
    ])
    ...
    prisonApi.getSentenceTerms.mockResolvedValue([
      ...
      },
      {
        ...
        caseId: 7,
        sentenceTermCode: 'IMP',
        sentenceTypeDescription: 'Some sentence info 7',
      },
      {
        lineSeq: 8,
        sentenceSequence: 9,
        ...
        caseId: 8,
        sentenceTermCode: 'IMP',
        sentenceTypeDescription: 'Some sentence info 8',
      },
      {
        lineSeq: 9,
        sentenceSequence: 10,
        ...
        caseId: 9,
        sentenceTermCode: 'IMP',
        sentenceTypeDescription: 'Some sentence info 9',
      },
      {
        lineSeq: 10,
        sentenceSequence: 11,
