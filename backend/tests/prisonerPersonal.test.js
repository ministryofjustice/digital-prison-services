                ...
                personal: [
                  {
                    ...
                    details: [
                      ...
                      {
                        label: 'Phone number',
                        value: '02222222222,<br>033333333333 extension number 777',
                        useHtml: true,
                      },
                      ...
                      {
                        label: 'Address phone',
                        value: '011111111111,<br>011333444 extension number 777',
                        useHtml: true,
                      },
                ...
                professional: [
                  {
                    ...
                    details: [
                      ...
                      {
                        label: 'Phone number',
                        value: '04444444444,<br>055555555555 extension number 123',
                        useHtml: true,
                      },
                      ...
                      { label: 'Country', value: 'England' },
                      { label: 'Address phone', value: '011111111111', useHtml: true },
                ...
                personal: [
                  {
                    ...
                    details: [
                      { label: 'Relationship', value: 'Cousin' },
                      { label: 'Phone number', value: '02222222222,<br>033333333333', useHtml: true },
                      { label: 'Email', value: 'test1@email.com, test2@email.com' },
                      { label: 'Address', value: 'Flat A, 13, High Street' },
                      { label: 'Town', value: 'Ulverston' },
                      { label: 'Postcode', value: 'LS1 AAA' },
                ...
                personal: [
                  {
                    ...
                    details: expect.not.arrayContaining([
                      { label: 'Phone number', value: '', useHtml: true },
                      { label: 'Email', value: '' },
                    ]),
                  },
                ],
            ...
            addresses: [
              {
                ...
                details: [
                  ...
                  { label: 'Postcode', value: 'LS1 AAA' },
                  { label: 'Country', value: 'England' },
                  { label: 'Phone', value: '011111111111', useHtml: true },
