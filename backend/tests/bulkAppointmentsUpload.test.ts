...
describe('bulk appointments upload', () => {
  ...
  describe('post', () => {
    beforeEach(() => {
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'loadAndParseCsvFile' does not exist on t... Remove this comment to see the full error message
      csvParser.loadAndParseCsvFile = jest.fn()
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'loadFromCsvContent' does not exist on ty... Remove this comment to see the full error message
