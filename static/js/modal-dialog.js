...
ModalDialogue.prototype.handleFocusTrap = function (event) {
  ...
  if (hasFocusEscaped) {
    // FIXED nodeListForEach(this.$focussable, function (element) {
    Array.prototype.forEach.call(this.$focussable, function (element) {
